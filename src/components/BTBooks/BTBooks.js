...
class BTBooks extends React.Component{
    ...
    componentDidMount(){
        ...
        fetch('http://localhost:8080/bt/sem3',{
            method : 'GET',
        ...
        fetch('http://localhost:8080/bt/sem4',{
            method : 'GET',
            headers : {'Accept' : 'applications/json'}
        }).then((res)=>res.json()).then((res)=>{
            console.log(res);
            ...
            fetch('http://localhost:8080/bt/sem5',{
            method : 'GET',
            headers : {'Accept' : 'applications/json'}
        }).then((res)=>res.json()).then((res)=>{
            console.log(res);
            ...
            fetch('http://localhost:8080/bt/sem6',{
            method : 'GET',
            headers : {'Accept' : 'applications/json'}
        }).then((res)=>res.json()).then((res)=>{
            console.log(res);
