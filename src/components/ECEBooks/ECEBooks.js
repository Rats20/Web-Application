...
class ECEBooks extends React.Component{
    ...
    componentDidMount(){
        ...
        fetch('http://localhost:8080/ece/sem3',{
            method : 'GET',
        ...
        fetch('http://localhost:8080/ece/sem4',{
            method : 'GET',
            headers : {'Accept' : 'applications/json'}
        }).then((res)=>res.json()).then((res)=>{
            console.log(res);
            ...
            fetch('http://localhost:8080/ece/sem5',{
            method : 'GET',
            headers : {'Accept' : 'applications/json'}
        }).then((res)=>res.json()).then((res)=>{
            console.log(res);
            ...
            fetch('http://localhost:8080/ece/sem6',{
            method : 'GET',
            headers : {'Accept' : 'applications/json'}
        }).then((res)=>res.json()).then((res)=>{
            console.log(res);
