...
class CVBooks extends React.Component{
    ...
    componentDidMount(){
        ...
        fetch('http://localhost:8080/cv/sem3',{
            method : 'GET',
        ...
        fetch('http://localhost:8080/cv/sem4',{
            method : 'GET',
            headers : {'Accept' : 'applications/json'}
        }).then((res)=>res.json()).then((res)=>{
            console.log(res);
            ...
            fetch('http://localhost:8080/cv/sem5',{
            method : 'GET',
            headers : {'Accept' : 'applications/json'}
        }).then((res)=>res.json()).then((res)=>{
            console.log(res);
            ...
            fetch('http://localhost:8080/cv/sem6',{
            method : 'GET',
            headers : {'Accept' : 'applications/json'}
        }).then((res)=>res.json()).then((res)=>{
            console.log(res);
